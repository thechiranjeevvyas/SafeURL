...
def load_model():
    model_path = os.path.abspath("Malicious_URL_Prediction.h5")
...
with col2:
    st.image("https://raw.githubusercontent.com/thechiranjeevvyas/SafeURL/refs/heads/main/webapp/assets/SafeURL.jpeg")

with col3:
    st.write(' ')

st.markdown("<h1 style='text-align: center; color: #00FFFF'>SafeURL</h1>", unsafe_allow_html=True)
st.markdown("<h2 style='text-align: center; color: #00FFFF'>Malicious URL Detection</h2>", unsafe_allow_html=True)
st.markdown("<h3 style='text-align: center; color: #32CD32;'>Using AI Model</h3>", unsafe_allow_html=True)
st.markdown("<p style='text-align: center; color: #FFD700;'>This program utilizes Multilayer Perceptron Neural Network model with optimized hyper parameters using genetic algorithms to perform malicious URL detection</p>", unsafe_allow_html=True)
